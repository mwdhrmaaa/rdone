        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('scheduling.schedules.store') }}" method="POST" class="max-w-xl">
                        @csrf
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="time" name="scheduled_at" id="scheduled_at" class="w-full bg-gray-50 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
